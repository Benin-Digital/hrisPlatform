...
const submit = () => {
    form.post(route('collaborateurs.store'), {
        preserveScroll: true,
        onSuccess: () => {
            Swal.fire({
                title: 'Succès !',
                text: 'Le collaborateur a été créé avec succès. Un mot de passe a été généré.',
                icon: 'success',
                timer: 3000,
...
onMounted(() => {
    if (form.type === 'interne' && props.entites.length > 0) {
        form.entite_id = props.entites[0].id;
    }
});
</script>
            ...
            <div class="page-container max-w-5xl">
                ...
                <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div class="flex items-center">
                        <UserPlusIcon class="w-8 h-8 text-indigo-600 mr-3" />
                        <div>
                            <h1 class="text-2xl md:text-3xl font-extrabold text-gray-900 tracking-tight">Ajouter un collaborateur</h1>
                            <p class="text-sm text-gray-500 mt-1 font-medium">Créez un nouveau profil et définissez ses accès à la plateforme.</p>
                        </div>
                    </div>
                    <Link :href="route('collaborateurs.index')" class="btn bg-white border-gray-200 text-gray-600 hover:bg-gray-50 inline-flex items-center">
                ...
                <form @submit.prevent="submit" class="space-y-8">
                    ...
                    <div class="card border-0 shadow-sm p-6 md:p-8">
                        <h2 class="text-xs font-black text-gray-400 uppercase tracking-widest mb-8 flex items-center gap-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-2">
                            <div>
                                ...
                                <div v-if="form.errors.type" class="text-red-500 text-[10px] mt-1 font-bold">{{ form.errors.type }}</div>
                            </div>
                            ...
                            <div>
                                ...
                                <select 
                                    v-model="form.statut"
                                    class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-bold focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition shadow-sm"
                                >
                    ...
                    <div class="card border-0 shadow-sm p-6 md:p-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mt-2">
                            <div>
                                ...
                                <input v-model="form.prenom" type="text" placeholder="Jean" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-medium focus:ring-2 focus:ring-primary-500 transition shadow-sm" required />
                            ...
                            <div>
                                ...
                                <input v-model="form.nom" type="text" placeholder="DUPONT" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-medium focus:ring-2 focus:ring-primary-500 transition shadow-sm" required />
                            ...
                            <div>
                                ...
                                <input v-model="form.email" type="email" placeholder="email@entreprise.com" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-medium focus:ring-2 focus:ring-primary-500 transition shadow-sm font-bold text-gray-700" required />
                            ...
                            <div>
                                ...
                                <input v-model="form.telephone" type="text" placeholder="+221 ..." class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-medium focus:ring-2 focus:ring-primary-500 transition shadow-sm" />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input v-model="form.matricule" type="text" placeholder="Ex: M-001" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-bold focus:ring-2 focus:ring-primary-500 transition shadow-sm font-mono tracking-tighter" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-if="form.type === 'interne'" class="card border-0 shadow-sm p-6 md:p-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mt-2">
                            <div class="md:col-span-2">
                                ...
                                <input v-model="form.poste" type="text" placeholder="Ex: Développeur Senior" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-medium focus:ring-2 focus:ring-primary-500 transition shadow-sm" :required="form.type === 'interne'" />
                            </div>
                            <div>
                    ...
                    <div class="card border-0 shadow-sm p-6 md:p-8">
                        <div class="flex items-center justify-between mb-8">
                            ...
                            <span class="text-[10px] bg-indigo-50 text-indigo-700 px-3 py-1 rounded-full font-black uppercase tracking-wider">Accès Système</span>
                        </div>
                        
                        <div class="space-y-6">
                            <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest">Attribuer des rôles <span class="text-red-500">*</span></label>
                            ...
                            <div v-if="form.errors.role_ids" class="text-red-500 text-[10px] mt-2 font-bold">{{ form.errors.role_ids }}</div>
                    ...
                    <div class="flex items-center justify-end gap-6 pt-4">
                        <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest hidden md:block">
                            Assurez-vous que l'email est correct avant de créer l'accès.
                        </p>
                        <button
                            type="submit"
                        ...
                        >
                            ...
                            <span v-else class="flex items-center gap-2">
                                ...
                                <RocketLaunchIcon class="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                            </span>
                        </button>
                    </div>
                </form>
